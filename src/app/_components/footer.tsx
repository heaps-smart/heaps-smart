      ...
      <Container>
        <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          <div className="flex flex-col sm:flex-row items-center sm:space-x-4 space-y-4 sm:space-y-0">
            <p className="text-sm">
              <a href="mailto:hello@heaps-smart.com" className="text-neutral-700 dark:text-neutral-200 hover:underline">
                hello@heaps-smart.com
              </a>
            </p>
            <div className="hidden sm:block h-5 border-l border-neutral-300 dark:border-neutral-500"></div>
            <a
          ...
          <p className="text-sm text-center md:text-left">
            This website comes to you from Djiru Country in Far North Queensland.
          </p>
        </div>
      </Container>
    </footer>
