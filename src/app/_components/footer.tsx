...
export function Footer({ inverted = false }) {
  const bgColor = inverted ? "bg-gradient-to-r from-blue-900 to-teal-500" : "bg-neutral-50";
  const textColor = inverted ? "text-white" : "text-neutral-700";
  const borderColor = inverted ? "border-blue-800" : "border-neutral-200";
  const linkColor = inverted ? "text-teal-200" : "text-neutral-700";
          ...
          <div className="flex flex-col sm:flex-row items-center sm:space-x-6 space-y-4 sm:space-y-0">
            <p className="text-sm flex items-center space-x-2">
              <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="h-5 w-5" viewBox="0 0 24 24">
                <path d="M12 12.713l-11.188-7.713v14h22.376v-14l-11.188 7.713zm11.188-9.713h-22.376l11.188 7.713 11.188-7.713z" />
              </svg>
