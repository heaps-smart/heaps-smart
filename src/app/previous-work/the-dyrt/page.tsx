...
export default function PreviousWorkTheDyrtPage() {
  const tags = ["Mobile", "React Native", "GIS", "Offline-first", "Performance"];

  const techStack = [
    <Link key="rn" href="/tools-for-nonprofits/react-native">React Native</Link>,
    <Link key="maps" href="/tools-for-nonprofits/arcgis">GIS / Mapping</Link>,
  ...
  const sections = [
    {
      ...
      content: (
        <>
          Before Heaps Smart existed, work was undertaken as <b>Director of Mobile Development for The Dyrt</b>, one of the largest outdoor and campground review platforms in the United States. At the time, The Dyrt had no mobile apps. The entire mobile experience lived on the web, which left a major gap for people who relied on their phones while travelling through remote areas.
        </>
      ),
    },
    {
