...
const projects = [
	...
	},
	{
		...
		description:
			"Workshops and coaching that help managers and small teams build confidence with modern workplace tools, AI-enabled workflows, and agile-inspired ways of working.",
